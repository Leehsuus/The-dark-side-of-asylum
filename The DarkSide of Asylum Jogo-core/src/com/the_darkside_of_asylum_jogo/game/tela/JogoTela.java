...
public class JogoTela implements Screen {
	...
	public JogoTela(The_DarkSide_of_Asylum_Jogo jogoP) {
		...
		//interatividade
		this.jogador = new Heroi(this,"Imagens/poke.png", 40,36, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
		this.threadJogador = new Thread(jogador);
		this.npc1 = new NPC(this, "Imagens/poke.png","L", 40, 36, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
		this.threadNpc = new Thread(npc1);
		this.mesa = new Objetos(this, "Imagens/poke.png", 40, 36, Gdx.graphics.getHeight());
